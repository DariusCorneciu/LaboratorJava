...
```
Sa se defineasca in Java clasele descrise in Lab3Clase.png: Student, Profesor, Person
Aceste clase se vor face in pachetul numit "model".
- Student extends Person
- Profesor extends Person

Sa de defineasca o clasa Application in care se citeste de la tastatura tipul de operatie:
- create, read, update, delete
- quit care sa opreasca aplicatia

Clasa Application va apela o alta clasa numita StorageService.java.
Clasa StorageService se va defini in pachetul numit "service".
In clasa StorageService se vor stoca separat in doua liste(sau tablouri) studentii si profesorii.
```
